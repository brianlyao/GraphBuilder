 ...
 * as input and return a path (or null if no connecting path exists).
 *
 * @author Brian Yao
 */
public class ShortestPathTemplates {
	 ...
	 */
	public static void testSSUU(TriFunction<Graph, Node, Node, Path> algorithm) {
		...
		assertEquals("Path[0-(5)->1-(6)->2]", String.valueOf(algorithm.apply(graph, n[0], n[2])));
		assertEquals("Path[0-(9)->4-(8)->3]", String.valueOf(algorithm.apply(graph, n[0], n[3])));

		Edge e10 = new Edge(10, n[0], n[2], false);
		assertTrue(graph.addEdge(e10));

		assertEquals("Path[0-(10)->2]", String.valueOf(algorithm.apply(graph, n[0], n[2])));

		graph.removeEdge(e[0]);

		assertEquals("Path[0-(10)->2-(6)->1]", String.valueOf(algorithm.apply(graph, n[0], n[1])));
	}
	 ...
	 * @param algorithm The shortest path algorithm.
	 */
	public static void testSSUD(TriFunction<Graph, Node, Node, Path> algorithm) {
		...
		assertNull(algorithm.apply(graph, n[0], n[2]));
		assertEquals("Path[2-(7)->3-(8)->4-(9)->0]", String.valueOf(algorithm.apply(graph, n[2], n[0])));

		Edge e10 = new Edge(10, n[3], n[0], true);
		assertTrue(graph.addEdge(e10));

		assertEquals("Path[2-(7)->3-(10)->0]", String.valueOf(algorithm.apply(graph, n[2], n[0])));

		graph.removeEdge(e10);
		graph.removeEdge(e[3]);

		assertNull(algorithm.apply(graph, n[2], n[0]));
	}
	 ...
	 * @param algorithm The shortest path algorithm.
	 */
	public static void testSSUM(TriFunction<Graph, Node, Node, Path> algorithm) {
		...
		assertEquals("Path[3-(7)->2]", String.valueOf(algorithm.apply(graph, n[3], n[2])));
		assertEquals("Path[3-(10)->0-(5)->1]", String.valueOf(algorithm.apply(graph, n[3], n[1])));
		assertEquals("Path[0-(10)->3]", String.valueOf(algorithm.apply(graph, n[0], n[3])));

		graph.removeEdge(e[5]);

		assertEquals("Path[0-(9)->4-(8)->3]", String.valueOf(algorithm.apply(graph, n[0], n[3])));
		assertNull(algorithm.apply(graph, n[3], n[1]));
	}
	 ...
	 * @param algorithm The shortest path algorithm.
	 */
	public static void testMSUU(TriFunction<Graph, Node, Node, Path> algorithm) {
		int constraints = GraphConstraint.SIMPLE | GraphConstraint.UNDIRECTED | GraphConstraint.UNWEIGHTED;
		Graph graph = new Graph(constraints);
		...
		assertEquals(n0n6path, String.valueOf(algorithm.apply(graph, n[0], n[6])));

		String n0n9path = "Path[0-(12)->1-(14)->3-(20)->8-(22)->9]";
		assertEquals(n0n9path, String.valueOf(algorithm.apply(graph, n[0], n[9])));

		String n11n6path = "Path[11-(24)->7-(19)->4-(15)->2-(17)->5-(18)->6]";
		assertEquals(n11n6path, String.valueOf(algorithm.apply(graph, n[11], n[6])));

		Edge e25 = new Edge(25, n[6], n[8], false);
		assertTrue(graph.addEdge(e25));
		String n11n6path2 = "Path[11-(24)->7-(19)->4-(21)->8-(25)->6]";
		assertEquals(n11n6path2, String.valueOf(algorithm.apply(graph, n[11], n[6])));

		graph.removeEdge(e[1]);
		String n1n6path = "Path[1-(14)->3-(20)->8-(25)->6]";
		assertEquals(n1n6path, String.valueOf(algorithm.apply(graph, n[1], n[6])));
	}
	 ...
	 * @param algorithm The shortest path algorithm.
	 */
	public static void testMSUD(TriFunction<Graph, Node, Node, Path> algorithm) {
		int constraints = GraphConstraint.SIMPLE | GraphConstraint.DIRECTED | GraphConstraint.UNWEIGHTED;
		Graph graph = new Graph(constraints);
		...
		assertEquals(n0n8path, String.valueOf(algorithm.apply(graph, n[0], n[8])));

		String n7n6path = "Path[7-(20)->2-(12)->3-(14)->5-(17)->6]";
		assertEquals(n7n6path, String.valueOf(algorithm.apply(graph, n[7], n[6])));

		String n6n0path = "Path[6-(19)->7-(20)->2-(12)->3-(13)->0]";
		assertEquals(n6n0path, String.valueOf(algorithm.apply(graph, n[6], n[0])));
		...
		assertEquals(n0n8path2, String.valueOf(algorithm.apply(graph, n[0], n[8])));

		String n6n0path2 = "Path[6-(19)->7-(20)->2-(12)->3-(14)->5-(16)->4-(15)->0]";
		assertEquals(n6n0path2, String.valueOf(algorithm.apply(graph, n[6], n[0])));

		String n6n1path = "Path[6-(19)->7-(21)->8-(22)->1]";
		assertEquals(n6n1path, String.valueOf(algorithm.apply(graph, n[6], n[1])));
	}
	 ...
	 * @param algorithm The shortest path algorithm.
	 */
	public static void testMSUM(TriFunction<Graph, Node, Node, Path> algorithm) {
		int constraints = GraphConstraint.SIMPLE | GraphConstraint.MIXED | GraphConstraint.UNWEIGHTED;
		Graph graph = new Graph(constraints);
		Node[] n = TestUtils.newNodes(12, 0);
		...
		assertEquals(n6n1path2, String.valueOf(algorithm.apply(graph, n[6], n[1])));
		...
		assertEquals(n0n9path2, String.valueOf(algorithm.apply(graph, n[0], n[9])));

		String n10n1path = "Path[10-(27)->11-(28)->3-(16)->2-(15)->1]";
		assertEquals(n10n1path, String.valueOf(algorithm.apply(graph, n[10], n[1])));
		...
		assertEquals(n10n1path2, String.valueOf(algorithm.apply(graph, n[10], n[1])));
	}
